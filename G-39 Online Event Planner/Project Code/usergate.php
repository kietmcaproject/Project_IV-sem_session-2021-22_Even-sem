...
include"connect.php";
	$res= mysqli_query($con,"select * from decoration where d_ref='gate.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/><br />
			<h4 style="color:#FFF">
            	...
            	<a href="userdecoration.php" style="color:#FFF; text-decoration:none">Decoration </a> <img src="img/back-ar.gif"/> <span style="color:#FFF">Entry Gate</span>  
            </h4>
		</div><br />
