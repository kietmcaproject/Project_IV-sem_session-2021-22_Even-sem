...
<?php 
  ...
  {
	  $id=$_GET['c_id'];
	  $res=mysqli_query($con,"select * from catering where c_id=$id");
...
<div class="container container-fluid">
	<div class="panel panel-default panel-info">
        ...
        <h2>Update Catering Information</h2>
        </div>
        ...
        <?php
			...
			{
				?>
                <div class="navbar alert alert-success">Catering Successfully Updated..</div>
                <?php
			}
		  ?>
           <?php
        ...
        <div class="form-control-static container-fluid">
        	<form action="updatecateringdb.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="name"  class="form-control"
                 placeholder="Enter Food Item Name" value="<?php echo $name;?>" />
                </div>
                <br/>
               <div class="form-horizontal">
                ...
                <input type="text" name="des" required class="form-control"
                 placeholder="Enter description..." value="<?php echo $descri;?>"/>
                </div>
                <br/>
                ...
                <input type="text" name="ref" required class="form-control"
                 placeholder="Enter reference url..." value="<?php echo $ref;?>"/>
                </div>
                <br/>
                <div class="form-horizontal"><span class="glyphicon glyphicon-credit-card"></span>
                    <input type="hidden" name="id" value="<?php echo $id;?>"/>
                ...
                <input type="text" name="uref" required class="form-control"
                 placeholder="Enter user reference url..." value="<?php echo $uref;?>"/>
                </div>
                <br/>
                <div class="form-horizontal"><span class="glyphicon glyphicon-credit-card"></span>
                    <input type="hidden" name="id" value="<?php echo $id;?>"/>
                ...
                <input type="text" name="ind" required class="form-control"
                 placeholder="Enter item ingredients..." value="<?php echo $ingredient;?>"/>
                </div>
                <br/>
	           <div class="form-horizontal"><span class="glyphicon glyphicon-credit-card"></span>			<input type="hidden" name="id" value="<?php echo $id;?>"/>
                <label>Item Price:</label>
                <input type="text" name="pri" required class="form-control"
                 placeholder="Enter item price..." value="<?php echo $price;?>"/>
                </div>
                <br/>
                
                <button type="submit" class="form-control btn btn-xs btn-success" onClick="update()"><span class="glyphicon glyphicon-registration-mark"></span>Update Catering</button>
            </form>
        </div>
	</div>
</div>
