	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/><br/>
			<h4>
            	...
            	<a href="ucont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Get togather</span>  
            </h4>
		</div><br />
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
        						<div class="item active">
            						<img src="img/get/11.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
					            	<img src="img/get/22.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
            						<img src="img/get/33.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/get/44.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/get/55.jpg" style="width:100%; height:200px"/>
					            </div>
             					<div class="item">
            						<img src="img/get/66.jpg" style="width:100%; height:200px"/>
					            </div>
					        </div>
