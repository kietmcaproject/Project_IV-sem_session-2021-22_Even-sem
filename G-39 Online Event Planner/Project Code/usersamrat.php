...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/><br />
			<h4 style="color:#FFF">
            	...
            	<a href="uservenue.php" style="color:#FFF; text-decoration:none">Venues </a> <img src="img/back-ar.gif"/><a href="userwest.php" style="color:#FFF; text-decoration:none"> </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Samrat-Heavens Hotel</span>  
            </h4>
		</div><br />
