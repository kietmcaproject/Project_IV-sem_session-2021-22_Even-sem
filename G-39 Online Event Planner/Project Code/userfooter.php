...
<div class="container-fluid" style="background-color:#000">
	<div class="row">
	      <div class="col-sm-4">
        	  ...
        	  <ul style="color:#FFF"> 
              		<li><a href="homeuser.php" style="color:#FFF;text-decoration:none">Home</a></li> 
                    <li><a href="useraboutus.php"  style="color:#FFF;text-decoration:none">About Us</a>
    	  ...
    	  <div class="col-sm-4">
        	  <p class="#" style="color:#F96;text-shadow:#FFF 1px 1px 1px; font-size:20px; font-family:Verdana, Geneva, sans-serif">Main Navigations</p>
       		   <p class="#">
          		<ul style="color:#FFF"> 
                	<li> <a href="feedback.php"  style="color:#FFF;text-decoration:none">Feedback</a></li>
                    <li><a href="ucont.php"  style="color:#FFF;text-decoration:none">Events/Party </a></li> 
                    <li><a href="status.php"  style="color:#FFF;text-decoration:none"> Booking Status</a></li></p>
                </ul>
          </div><!--Column 2 close-->
      	...
      	<div class="col-sm-4">
        	<p class="#" style="color:#F96;text-shadow:#FFF 1px 1px 1px; font-size:20px; font-family:Verdana, Geneva, sans-serif">Basic Links</p>
        	  <ul style="color:#FFF"> 
              		<li><a href="uservenue.php" style="color:#FFF;text-decoration:none">Venues</a></li> 
                    <li><a href="userdecoration.php"  style="color:#FFF;text-decoration:none">Decoration</a>
                    </li> 
                    <li><a href="logout.php" style="text-decoration:none; color:#FFF">logout</a></li>
              </ul>
       </div><!--Column 3 close-->
   </div><!--Row close-->
