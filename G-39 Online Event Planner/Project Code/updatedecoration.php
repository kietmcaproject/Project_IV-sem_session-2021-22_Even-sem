...
<script language="javascript">
	function update()
	{
		alert('You have successfully updated the decoration...');
	}
</script>
</head>
<body>
<?php 
  ...
  {
	  $id=$_GET['d_id'];
	  $res=mysqli_query($con,"select * from decoration where d_id=$id");
...
<div class="container container-fluid">
	<div class="panel panel-default panel-info">
        ...
        <?php
			...
			{
				?>
                <div class="navbar alert alert-success">Decoration Successfully Updated..</div>
                <?php
			}
		  ?>
           <?php
        ...
        <div class="form-control-static container-fluid">
        	<form action="updatedecorationdb.php" method="post" enctype="multipart/form-data">
	           ...
	           <div class="form-horizontal"><span class="glyphicon glyphicon-credit-card"></span>			<input type="hidden" name="id" value="<?php echo $id;?>"/>
                ...
                <button type="submit" class="form-control btn btn-xs btn-success" onClick="update()"><span class="glyphicon glyphicon-registration-mark"></span>Update Decoration Details</button>
            </form>
        </div>
	</div>
</div>
