...
include"connect.php";
  $res= mysqli_query($con,"select * from catering")or die(mysqli_error());
?>
<br/><br/><br/>
<table class="table table-bordered table-bordered" style="margin-left:8px;width:99%">
 <tr bgcolor="#FF9966">
   ...
   <th><center>Catering Reference</center></th>
   <th><center>User Catering Reference</center></th>
  ...
  <?php while($row=mysqli_fetch_array($res)){?>
     <tr style="color:#FFF">
     <td style="width:18%">
     	<a href="addcatering.php" style="color:#FFF;"><button type="button" class="btn btn-success">Add</button></a>
        <a href="deletecatering.php?c_id=<?php echo $row[0];?>" style="color:#FFF;"><button type="button" class="btn btn-danger" onClick="del()">Delete</button></a>
        <a href="updatecatering.php?c_id=<?php echo $row[0];?>" style="color:#FFF;"><button type="button" class="btn btn-primary">Update</button></a></td>
