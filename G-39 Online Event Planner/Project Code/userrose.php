...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/><br />
			<h4 style="color:#FFF">
            	...
            	<a href="ucatering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="userbeverages.php" style="color:#FFF; text-decoration:none">Beverages </a><img src="img/back-ar.gif"/><a href="usershake.php" style="color:#FFF; text-decoration:none">Shakes </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Rose-Shake</span>  
            </h4>
		</div><br />
