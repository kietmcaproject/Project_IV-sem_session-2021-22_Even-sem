	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/><br/>
			<h4>
            	...
            	<a href="ucont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Cocktail Party</span>  
            </h4>
		</div><br />
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
        						<div class="item active">
            						<img src="img/cock/qq.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
					            	<img src="img/cock/k.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
            						<img src="img/cock/maxresdefault (1).jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/cock/Elegant-cocktail-party-table.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/cock/maxresdefault.jpg" style="width:100%; height:200px"/>
					            </div>
					        </div>
