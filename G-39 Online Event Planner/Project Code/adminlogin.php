...
<div class="container-fluid"  style="width:40%; min-height:400px;">
        ...
        <h1 style="color:#006; font-family:'MS Serif', 'New York', serif; font-size:36px; text-shadow:#000 2px 1px 1px"><center><u>Admin Log In</u></center></h1>
        <br/>
        
	    
    	    	<form action="adminlogindb.php" method="post" enctype="multipart/form-data">
                ...
                <a href="adminsignup.php"><center>Create account</center></a>
                </form>
                </div>
