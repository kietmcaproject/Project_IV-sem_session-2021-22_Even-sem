    ...
    <div className="header">
      ...
      <div className="header_nav">
        <div className="header_signIn">
          ...
          <div className="header_signIn">
            <Link to={!user && "/login"} className="header_linkToLogin ">
              <div className="header_options" onClick={handleLogout}>
                <span className="header_lineOne">
                  {user ? fire.auth().currentUser?.email : "Hello, Guest"}
                </span>
                <span className="header_lineTwo">
                  {user ? fire.auth().currentUser?.displayName : "Sign In"}
                </span>
              </div>
            </Link>
            ...
            {user ? (
              <div className="header_SignInMenu">
                <button className="header_signInmenuBtn" onClick={handleLogout}>
                  Logout
                </button>
              </div>
            ) : (
              <div className="header_SignInMenu">
                ...
                <div className="header_SignInMenuText">
                  New Customer?
                  <Link to="/signup" className="header_SignInMenu_signupLink">
                    <span className="header_SignInMenu_signup">
                      {" "}
                      Start here.
                    </span>
                  </Link>
          ...
          <div className="header_arrowup"></div>{" "}
          {/* for little triangle near the signin button*/}
        </div>
        ...
        <Link to="/cart" className="header_linkToCart">
          <div className="header_optionCart">
            ...
            <span className="header_lineTwo header_cartCount">
              {basket?.length}
            </span>
          </div>
        </Link>
