    ...
    return (
        <div className="login">
            ...
            <div className="login_form" >
                ...
                <p>By continuing, you agree to E-commerce's <span className="login_form_pSpan">Conditions of Use</span> and <span className="login_form_pSpan">Privacy Notice.</span></p>
            </div>

            <span className="login_line"></span>
            <span className="login_linePara"> New to E-commerce?</span>

            <Link to="/signup">
            <button className="login_register">Create your E-commerce account</button>
            </Link>
